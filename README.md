...
- common_new.css : 컴포넌트 공통 스타일
- layout_new.css : 기본 레이아웃 css
- layout_4k.css : 4K 레이아웃 css

## fonts
font-weight: 300,400,500,700,900

[ Google font helper ] (https://google-webfonts-helper.herokuapp.com/fonts/noto-sans-kr?subsets=korean,latin)
